#!/usr/bin/env python3
"""
Remove Single Quotes Adjacent to Angle Brackets
------------------------------------------
This script removes single quotes when they are adjacent to angle brackets in JSONL files.
It specifically targets patterns like ' <' or '> ' and removes the single quotes.
"""
...
def remove_adjacent_quotes(text):
    """
    Remove single quotes when they are adjacent to angle brackets.
    
    Args:
        text (str): The text to process
        
    Returns:
        str: The processed text with adjacent single quotes removed
    """
...
def process_file(input_file, output_file=None):
    """
    Process a JSONL file to remove single quotes adjacent to angle brackets.
    ...
    Returns:
        tuple: (Number of lines processed, Number of messages changed)
    """
                ...
                if 'messages' in data:
                    for message in data['messages']:
                        if 'content' in message:
                            ...
                            processed_content = remove_adjacent_quotes(original_content)
...
def main():
    parser = argparse.ArgumentParser(description='Remove single quotes adjacent to angle brackets in JSONL files')
